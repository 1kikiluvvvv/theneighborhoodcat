...
function downloadData() {
    ...
    axios.post('/dashboard/events/download', {}, { responseType: 'arraybuffer' })  // Add responseType to the config
        .then(response => {
            ...
            if (response.data instanceof ArrayBuffer) {
                ...
                link.href = url;
                link.setAttribute('download', 'events_data.zip');
...
removeSelectedButton.addEventListener('click', () => {
    ...
    axios.post('/dashboard/events/remove-item', requestBody, {
        headers: {
